        ...
        <div class="col-lg-12">
          ...
          <div class="card card-outline-secondary my-4">
            ...
            <div class="card-body">
              ...
              <hr>
              <a href="<spring:url value='/profile/edit' />" class="btn btn-success">Edit Profile</a> 
              <a href="<spring:url value='/profile/changePassword' />" class="btn btn-success">Change Password</a>
            </div>
          </div>
          <!-- /.card -->
