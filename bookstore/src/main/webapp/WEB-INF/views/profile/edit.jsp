      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card card-outline-secondary my-4">
            ...
            <form:form class="form-horizontal" modelAttribute="user"  role="form" method="post" action="/bookstore/profile/edit ">
            ...
            <div class="card-body">
				  ...
				  <tbody>
				    <tr>
				      ...
				      <td colspan="4" class="text-left">      
        				  <form:input type="input" class="form-control" path="username" placeholder="firstName" value="${user.username}" readonly="true"/>
       				  </td>
				    </tr>
				    <tr>
				      <td>First Name</td>
              ...
              <hr>
              <button type="submit" class="btn btn btn-success">Save Profile</button> <a href="<spring:url value="/profile" />" class="btn btn btn-success">Back</a>
            </div>
           </form:form>
          </div>
          <!-- /.card -->
