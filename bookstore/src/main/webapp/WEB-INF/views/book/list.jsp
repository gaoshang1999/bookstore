    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="<spring:url value="/book/edit/${book.id}" />" class="btn btn-primary"> Edit    </a>    </td>
	     
	     <td><form action="<spring:url value="/book/delete/${book.id}" />" method="post"> <button type="submit" onclick="return del();" class="btn btn-primary" >Delete</button> </form>  </td>
